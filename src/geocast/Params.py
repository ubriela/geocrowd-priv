...
class Params(object):
    ...
    def select_dataset(self):
        if Params.DATASET == "gowallasf":
            ...
            Params.x_min=33.699476 ; Params.y_min=-118.570633; Params.x_max=34.319887; Params.y_max=-118.192978          
            ...
            Params.x_min=32.8768481 ; Params.y_min=-112.875481; Params.x_max=33.806805; Params.y_max=-111.671219 ;
            ...
            Params.x_min=32.1714; Params.y_min=-124.3041; Params.x_max=64.8490; Params.y_max=-67.2804 # mcdonald
        elif Params.DATASET == "gowalla_ca":
            Params.dataset = '../../dataset/gowalla_CA.dat'; Params.resdir = '../../output/gowalla_ca/'
            Params.x_min=-124.3041; Params.y_min=32.1714; Params.x_max=-114.0043; Params.y_max=41.9984 #gowalla_CA
        elif Params.DATASET == "tiger":
            Params.dataset = '../../dataset/tiger_NMWA.dat'; Params.resdir = '../../output/tiger/'
            Params.x_min=-124.8193; Params.y_min=31.3322; Params.x_max=-103.0020; Params.y_max=49.0025 # tiger
        elif Params.DATASET == "landmark":
            Params.dataset = '../../dataset/landmark.dat'; Params.resdir = '../../output/landmark/'
            Params.x_min=-124.4384; Params.y_min=24.5526; Params.x_max=-67.0255; Params.y_max=49.0016 # landmark
        elif Params.DATASET == "restrnts":
            Params.dataset = '../../dataset/restrnts.dat'; Params.resdir = '../../output/restrnts/'
            Params.x_min=-124.4972; Params.y_min=24.5473; Params.x_max=-66.9844; Params.y_max=48.9999 # restrnts
        elif Params.DATASET == "shopping":
            Params.dataset = '../../dataset/shopping.dat'; Params.resdir = '../../output/shopping/'
            Params.x_min=-124.2640; Params.y_min=24.5515; Params.x_max=-68.2106; Params.y_max=48.9939 # shopping
        elif Params.DATASET == "parkrec":
            Params.dataset = '../../dataset/parkrec.dat'; Params.resdir = '../../output/parkrec/'
            Params.x_min=-124.5249; Params.y_min=24.5510; Params.x_max=-66.9687; Params.y_max=49.0010 # parkrec
        elif Params.DATASET == "zipcode":
            Params.dataset = '../../dataset/zipcode.dat'; Params.resdir = '../../output/zipcode/'
            Params.x_min=-176.6368; Params.y_min=17.9622; Params.x_max=-65.2926; Params.y_max=71.2995 # zipcode
        elif Params.DATASET == "truck":
            Params.dataset = '../../dataset/truck.dat'; Params.resdir = '../../output/truck/'
            Params.x_min=23.5100; Params.y_min=37.8103; Params.x_max=24.0178; Params.y_max=38.2966 # truck
        elif Params.DATASET == "ne":
            Params.dataset = '../../dataset/ne.dat'; Params.resdir = '../../output/ne/'
            Params.x_min=0.0470; Params.y_min=0.0543; Params.x_max=0.9530; Params.y_max=0.9457 # ne
        elif Params.DATASET == "na":
            Params.dataset = '../../dataset/na.dat'; Params.resdir = '../../output/na/'
            Params.x_min=-174.2057; Params.y_min=14.6805; Params.x_max=-52.7316; Params.y_max=79.9842 # na
        elif Params.DATASET == "buses":
            Params.dataset = '../../dataset/buses.dat'; Params.resdir = '../../output/buses/'
            Params.x_min=22.3331; Params.y_min=37.8329; Params.x_max=24.0203; Params.y_max=38.7417 # buses
        elif Params.DATASET == "gowalla_sa":
            Params.dataset = '../../dataset/gowalla_SA.dat'; Params.resdir = '../../output/gowalla_sa/'
            Params.x_min=-63.3209; Params.y_min=-176.3086; Params.x_max=13.5330; Params.y_max=-32.4150 # gowalla_SA
